              ...
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                      <a class="dropdown-item" href="{{ route('sub-category') }}">View More</a>
                    </div>
                  </div>
                </div>
                <span class="fw-semibold d-block mb-1">Sub Category</span>
                <h3 class="card-title mb-2">{{$totalSubCategory}}</h3>
                {{-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +72.80%</small> --}}
              </div>
            </div>
          </div>
              ...
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                      <a class="dropdown-item" href="{{ route('trainer') }}">View More</a>
                    </div>
                  </div>
                </div>
               <span class="fw-semibold d-block mb-1">Trainer</span>
              ...
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                      <a class="dropdown-item" href="{{ route('media') }}">View More</a>
                    </div>
                  </div>
                </div>
                <span class="fw-semibold d-block mb-1">Media</span>
                <h3 class="card-title mb-2">{{$totalMedia}}</h3>
                {{-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +72.80%</small> --}}
              </div>
            </div>
          </div>
              ...
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt6">
                      <a class="dropdown-item" href="{{ route('subscription') }}">View More</a>
                    </div>
                  </div>
                </div>
               <span class="fw-semibold d-block mb-1">Subscription</span>
                <h3 class="card-title mb-2">{{$totalSubscription}}</h3>
              </div>
            </div>
          </div>
        </div>
